...
class UNet3D(nn.Module):
    def __init__(self, in_channels=1, out_channels=3, init_features=64):
        ...
        self.encoder_r_1 = UNet3D._block_r(features,features * 4, name="enc1_r")
        self.encoder_r_2 = UNet3D._block_r(features * 2,features * 8, name="enc2_r")
        self.encoder_r_3 = UNet3D._block_r(features * 4,features * 16, name="enc3_r")
        ...
        self.dncoder_r_1 = UNet3D._block_rr(features*16,features * 4, name="dnc1_r")
        self.dncoder_r_2 = UNet3D._block_rr(features * 8,features * 2, name="dnc2_r")
        self.dncoder_r_3 = UNet3D._block_rr(features * 4,features * 1, name="dnc3_r")
